...
const Sidebar = ({ width }) => {
  ...
  function MyVerticallyCenteredModal2(props) {
   ...
   const HistoricalData = async (e) => {
    e.preventDefault()
    try{
      const { data } = await axios.post("https://ant.aliceblueonline.com/rest/AliceBlueAPIService/api/chart/history" , {
        token  ,resolution , from , to , exchange
      })
    }catch(e) { 
      console.log(e)
    }
    ...
    <>
      ...
      <div className={darkTheme ? "darkTheme" : ""}>
        <div
          className={
            width
              ? "tem false-sidebar block sideBar"
              : "true-side false-sidebar sideBar "
          }
        >
          ...
          <div className="false-sidebar-menu">
            ...
            <div>
              ...
              <Dropdown style={{ marginLeft: "0px" }} className='ThemeDropDown ' >
                <Dropdown.Toggle id="dropdown-basic"  className="dropDwn">
                  <AiFillSetting style={{ width: " 20px", height: "20px" , marginLeft : '0px'}} />{" "}
                  Setting
                </Dropdown.Toggle>
