...
import { OrderModal, PortfoliModal } from "../../Modal/GetOrder";
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div className="sideItem" onClick={() =>{
              setOpenPModal(false)
            ...
            <div
              className="sideItem"
              onClick={() => setOpenPModal(!openPModal)}
            >
              <BsCashCoin style={{ width: " 20px", height: "20px" }} />
              PORTFOLIO
            </div>
            <div className="sideItem" onClick={() => setOrderOpen(!modalOpen)}>
              <BsCashCoin style={{ width: " 20px", height: "20px" }} />
              HOLDING
            </div>
            {SessionId ? (
