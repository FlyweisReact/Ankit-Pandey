      ...
      try {
        const { data } = await axios.post(
          ...
          },
          {
            headers: {
              Headers: {
                Authorization: `Bearer 764564 `,
              },
            },
          }
        );
      ...
      >
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <Form.Group className="mb-3">
              <Form.Select aria-label="Default select example"   onChange={(e) => setExch(e.target.value)}>
            ...
            <Form.Group className="mb-3">
              <Form.Select aria-label="Default select example"   onChange={(e) => setpCode(e.target.value)}>
            ...
            <Form.Group className="mb-3">
              <Form.Select aria-label="Default select example"   onChange={(e) => setComplexty(e.target.value)}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="number"   onChange={(e) => setComplexty(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
