...
export function HistoricalModal(props) {
  ...
  const [from, setFrom] = useState(localStorage.getItem("Historical_Data_From"));
      ...
      <Modal.Body className="PlaceOrderModal">
        ...
        <Form onSubmit={HistoricalData}>
          ...
          <Form.Select
            ...
            onChange={(e) => {
              localStorage.setItem(
                "One Minute Data",
                e.target.value === "1D" ? "One Minute Data" : "Day Data"
              );
              localStorage.setItem(
                "One Minute Data",
                e.target.value === "1D" ? "One Minute Data" : "Day Data"
          ...
          <Form.Group className="mb-3">
            <Form.Label>From {defaultFrom ? `( ${defaultFrom} ) `: ""} </Form.Label>
            <Form.Control
              type="date"
              onChange={(e) => {
                handleDateChange(e);
          ...
          <Form.Group className="mb-3">
            <Form.Label>To {defaultTo ? `( ${defaultTo} ) `: ""} </Form.Label>
            <Form.Control
              as="input"
              type="date"
              onChange={(e) => {
