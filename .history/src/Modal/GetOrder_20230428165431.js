...
export function PortfoliModal(props) {
  ...
  return (
    ...
    >
      <Modal.Header  style={{backgroundColor : '#0f2c64' , color : '#fff'}}>
      <i className="fa-solid fa-circle-xmark" sty ></i>
      </Modal.Header>
      <Modal.Body style={{backgroundColor : '#0f2c64'}}>
      ...
      <Modal.Footer style={{backgroundColor : '#0f2c64'}}></Modal.Footer>
    </Modal>
  );
}
