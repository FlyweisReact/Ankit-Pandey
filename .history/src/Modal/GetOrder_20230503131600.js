...
export function OrderModal(props) {
  ...
  const fetchTradeOrder = useCallback(() => {
    try {
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        {data?.emsg === 'No Data' ? <Alert>No Data Found</Alert> :       <div className="overflowCont">
          <Table striped bordered hover>
            <thead>
              <tr>
                <th>Price</th>
    ...
    >
      ...
      <Modal.Body>
        ...
        {show ? (
            ...
            data?.emsg === "No Data" ? <Alert>No Data Found</Alert> : 
