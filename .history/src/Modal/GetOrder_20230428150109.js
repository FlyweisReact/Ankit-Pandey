...
export function PortfoliModal(props) {
  ...
  const postHandler = async (e) => {
    e.preventDefault()
    try{
      const { data } = await axios.post("https://ant.aliceblueonline.com/rest/AliceBlueAPIService/api/positionAndHoldings/positionBook" , {
        ret
      } , {
        headers: {
          Authorization: `Bearer 764564  `,
    ...
    >
      ...
      <Modal.Body>
        ...
        <Form onSubmit={postHandler}>
          <Form.Select aria-label="Default select example" className="mb-3" onChange={(e) => setRet(e.target.value)}>
