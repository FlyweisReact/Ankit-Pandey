...
export function HistoricalModal(props) {
  ...
  const SessionId = localStorage.getItem("sessionId");
  const [resolution, setResolution] = useState(localStorage.getItem("One Minute Data"));
  ...
  console.log(localStorage.getItem("Historical_Data_From"))
  console.log(localStorage.getItem("Historical_Data_to"))
      ...
      <Modal.Body className="PlaceOrderModal">
        ...
        <Form onSubmit={HistoricalData}>
          ...
          <Form.Select
            ...
            className="mb-3"
            onChange={(e) => {
              localStorage.setItem("One Minute Data" , e.target.value === '1D' ? "One Minute Data" : "Day Data")
              setResolution(e.target.value)}}
          >
            <option value={resolution} disabled selected> -- {resolution ? resolution : "Select Resolution "} -- </option>
            <option value="1D">One Minute data</option>
