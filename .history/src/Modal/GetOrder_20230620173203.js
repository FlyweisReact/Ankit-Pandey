...
export function HistoricalModal(props) {
  ...
  const defaultTo = localStorage.getItem("Historical_Data_From")
    ...
    >
      <Modal.Body className="PlaceOrderModal">
        ...
        <Form onSubmit={HistoricalData}>
          ...
          >
            <option value={defaultResolution} disabled selected> -- {defaultResolution ? defaultResolution : "Select Resolution "} -- </option>
