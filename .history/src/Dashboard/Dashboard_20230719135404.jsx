          ...
          <>
            ...
            <div className="Graph">
              <div className="ChartContainer">
                ...
                <div className={darkTheme ? " darkChartType" : "chertType "}>
                  <p onClick={() => setCurrentTheme("floating")}>Dark</p>
                  <p onClick={() => setCurrentTheme("Tracking")}>Light</p>
                  <p onClick={() => setCurrentTheme("Magnifier")}>Color</p>
                </div>
              </div>

              <div ref={chartContainerRef} id="container" />
              <div ref={tooltipRef} className={tipType === "Magnifier" ? "floating-tooltip-3" : "floating-tooltip-2"} />
            </div>
          </>
        ) : (
