    ...
    if (chartContainerRef.current) {
      ...
      chartInstance.subscribeCrosshairMove((param) => {
        if (
          ...
          const seriesData = param.seriesPrices.values().next().value;
          const price = seriesData && seriesData.price;
          if (price !== undefined) {
            ...
            `;
            const coordinate = param.seriesPrices.keys().next().value;
            let left = param.point.x + toolTipMargin;
            if (left > chartContainerRef.current.clientWidth - toolTipWidth) {
              left = param.point.x - toolTipMargin - toolTipWidth;
            }
            let top = coordinate + toolTipMargin;
            if (top > chartContainerRef.current.clientHeight - toolTipHeight) {
              top = coordinate - toolTipHeight - toolTipMargin;
            }
