...
const Dashboard = () => {
  ...
  useEffect(() => {
    console.log(chartData , "Dsaddsad");
  }, [chartData]);
  ...
  useEffect(() => {
    console.log(chartData, "Above data");
    if (chartInstance) {
  ...
  useEffect(() => {
    console.log(chartData, "Down data");
    if (chartInstance) {
      const series = createSeries(chartType);
      series.setData(chartData);
      chartInstance.timeScale().fitContent();
