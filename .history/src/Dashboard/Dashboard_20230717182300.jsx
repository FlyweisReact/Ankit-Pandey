...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      // Configure and style the tooltip as needed
      toolTipRef.current = toolTip;
      chartContainerRef.current.appendChild(toolTip);

      const updateToolTip = (param) => {
        // Update tooltip logic based on chart parameters
      };

      chartInstance.subscribeCrosshairMove(updateToolTip);
  ...
  useEffect(() => {
    if (chartInstance) {
      const crosshairOptions = {
        ...
        vertLine: {
          visible: true, // Set to true to show the vertical crosshair line
          width: 1,
          color: '#C3BCDB44',
        ...
        horzLine: {
          visible: true, // Set to true to show the horizontal crosshair line
          color: '#9B7DFF',
          labelBackgroundColor: '#9B7DFF',
        },
      };

      chartInstance.applyOptions({ crosshair: crosshairOptions });
    }
  }, [chartInstance ,]);
