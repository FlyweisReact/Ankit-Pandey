        ...
        <div className="gridCont">
          ...
          >
            <Resizable
              width={cardWidth}
              height={300}
              onResize={(e, { size }) => setCardWidth(size.width)}
              minConstraints={[cardWidth, 300]}
              maxConstraints={[
                homeSDimensions.width - cardWidth,
                homeSDimensions.height,
              ]}
            >
              <div ref={cardRef}>
                <Card className="clear handle">{/* Card content */}</Card>
              </div>
            </Resizable>
          </Draggable>
        </div>
