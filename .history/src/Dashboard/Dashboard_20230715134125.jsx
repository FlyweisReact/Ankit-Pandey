...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const mappedData = historicalData?.result?.map((item) => ({
      time: item.time ,
      open: item.open,
      high: item.high,
      low: item.low,
    ...
    console.log(candlestickData, "candlestickDatadsadas");
    ...
    candlestickSeries.setData([{ time: '2018-12-22', open: 75.16, high: 82.84, low: 36.16, close: 45.72 },
