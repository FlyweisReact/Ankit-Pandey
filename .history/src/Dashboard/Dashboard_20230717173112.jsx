  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      if (chartType === "candles") {
        ...
        const barSeries = chartInstance.addBarSeries({ upColor: '#26a69a', downColor: '#ef5350' });
        ...
        const areaSeries = chartInstance.addAreaSeries({ lineColor: '#2962FF', topColor: '#2962FF', bottomColor: 'rgba(41, 98, 255, 0.28)' });
