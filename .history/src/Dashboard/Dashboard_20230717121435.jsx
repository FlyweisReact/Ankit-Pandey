...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if ( historicalData || historicalData?.length > 0) {
      ...
      console.log( historicalData ,  "Here")
      const chartOptions = {
        layout: {
          textColor: "#000",
          background: {
      ...
      if (chartRef.current) {
        ...
        console.log(mappedData , "Mappe abouve  ")
        ...
        console.log( historicalData , "There")
        ...
        console.log(mappedData , "Mappe dOne3 ")
        const stickArray =
          Array.isArray(mappedData) && mappedData?.length > 0 ? mappedData : [];
        candlestickSeries.setData(stickArray);
        chart.timeScale().fitContent();
  ...
  }, [historicalData, ThemeSelector, darkTheme , to, from ]);
