    ...
    return (
      <>
        ...
        bounds={{
              left: 0,
              top: 0,
              right: document.querySelector(".gridCont").clientWidth,
              bottom: document.querySelector(".gridCont").clientHeight,
            }}
      >
        <div ref={cardRef}>
          <Card className="clear2">
            <Card.Body>
              ...
              <div className="filterDiv handle">
                ...
                >
                  {' '}
                  <AiOutlineSearch style={{ width: '25px', height: '25px' }} /> Filter
