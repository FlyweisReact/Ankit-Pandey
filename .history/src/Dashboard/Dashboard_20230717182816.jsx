...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      cha.subscribeCrosshairMove((param) => {
        if (
          ...
          toolTip.innerHTML = `<div style="color: #2962FF">Apple Inc.</div><div style="font-size: 24px; margin: 4px 0px; color: black">${Math.round(
            100 * price
          ) / 100}</div><div style="color: black">${dateStr}</div>`;
