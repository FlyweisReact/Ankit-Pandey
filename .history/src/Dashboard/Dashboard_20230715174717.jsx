...
const Dashboard = () => {
  ...
  const convertDateToEpoch = (date) => {
    ...
    const newDate = epoch.toString();
    console.log(newDate)
      GetHistoricalDefault(newDate);
  ...
  const GetHistoricalDefault = async (newDate) => {
    console.log("Get Historical Data Application")
    console.log(newDate)
    const payload = {
      token,
      resolution: "D",
