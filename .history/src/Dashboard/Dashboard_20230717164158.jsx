  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      const applyTheme = (theme) => {
        const chartOptions = themesData[theme].chart;
        chartInstance.applyOptions(chartOptions);
      
        const series = chartInstance.getVisibleSeries();
        series.forEach((s) => {
          const seriesType = s.seriesType();
          const seriesConfig = themesData[theme].series[seriesType];
          s.applyOptions(seriesConfig);
        });
      };
