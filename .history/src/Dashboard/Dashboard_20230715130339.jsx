...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    console.log(historicalData , "Historicald")
    const DataMapping = historicalData?.result;

    const Mapps = DataMapping?.map((i) => i)
    console.log(Mapps , "Mappsds")

    candlestickSeries.setData(Mapps);
