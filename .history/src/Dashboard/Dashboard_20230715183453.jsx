...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (historicalData) {
      const chartOptions = {
        layout: {
          textColor: darkTheme ? "#fff" : "#2c3236",
          background: { type: "solid", color: darkTheme ? "#000" : "#fff" },
        },
      };
      ...
      if (chartRef.current) {
        ...
        const candlestickSeries = chart.addCandlestickSeries({
          upColor: darkTheme ? "#26a69a" : "#fff",
          downColor: darkTheme ? "#ef5350" : "#ef5350",
          borderVisible: false,
          wickUpColor: darkTheme ? "#26a69a" : "#26a69a",
          wickDownColor: darkTheme ? "#ef5350" : "#ef5350",
        });
        ...
        const stickArray =
          Array.isArray(mappedData) && mappedData?.length > 0 ? mappedData : [];
        candlestickSeries.setData(stickArray);
