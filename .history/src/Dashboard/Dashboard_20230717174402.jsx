...
import { createChart, createCrosshair , CrosshairMode  } from "lightweight-charts";
...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      const floatingTooltip = chartInstance.createCrosshair({
      ...
      // Add the floating tooltip to the chart
      chartInstance.addCustomCrosshairTool(floatingTooltip);
