...
const Dashboard = () => {
  ...
  const calculatePrevDate = () => {
    ...
    prevDate.setDate(prevDate.getDate() - 100);
    return prevDate;
  };
  ...
  useEffect(() => {
    ...
    if (chartContainerRef.current) {
      ...
      if (chartType === "candles") {
        ...
        toolTip.style = `width: ${}; height: 80px; position: absolute; display: none; padding: 8px; box-sizing: border-box; font-size: 12px; text-align: left; z-index: 1000; top: 12px; left: 12px; pointer-events: none; border: 1px solid; border-radius: 2px;font-family: -apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;`;
