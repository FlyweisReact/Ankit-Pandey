      ...
      const DataChecker = (chartType) => {
        switch (chartType) {
          ...
          case "area":
            return () => {
              setChartData([
                { time: 1545446400000, value: 32.51 },
                { time: 1545532800000, value: 31.11 },
                { time: 1545619200000, value: 27.02 },
                { time: 1545705600000, value: 27.32 },
                { time: 1545792000000, value: 25.17 },
                { time: 1545878400000, value: 28.89 },
                { time: 1545964800000, value: 25.46 },
                { time: 1546051200000, value: 23.92 },
                { time: 1546137600000, value: 22.68 },
                { time: 1546224000000, value: 22.67 },
              ]);
            };
          default:
            return () => {
