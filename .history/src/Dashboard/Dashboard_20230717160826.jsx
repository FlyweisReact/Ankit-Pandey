  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      if (chartType === "candles") {
        const candlestickSeries = createChart.addCandlestickSeries({
          upColor: "#26a69a",
          downColor: "#ef5350",
          borderVisible: false,
          wickUpColor: "#26a69a",
        ...
        createChart.timeScale().fitContent();
      } else if (chartType === "bars") {
        const barSeries = createChart.addBarSeries({
          upColor: "#26a69a",
          downColor: "#ef5350",
        });
        ...
        const areaSeries = createChart.addAreaSeries({
          lineColor: "#2962FF",
          topColor: "#2962FF",
        ...
        const lineSeries = createChart.addLineSeries({ color: "#2962FF" });
