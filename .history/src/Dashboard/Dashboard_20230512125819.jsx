...
const Dashboard = () => {
  ...
  useEffect(
    () => {
      ...
      function createWidget() {
        if (document.getElementById('tradingview_46118') && 'TradingView' in window) {
  ...
  return (
    <>
      ...
      <div className='tradingview-widget-container' style={{width : '1400px' , height : '100%'}}>
      <div id='tradingview_46118' style={{width : '100%' , height : '1400px'}}/>
      <div className="tradingview-widget-copyright" style={{width : '1400px' , height : '100%'}}>
