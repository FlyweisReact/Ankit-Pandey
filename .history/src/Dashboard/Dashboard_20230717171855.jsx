  ...
  useEffect(() => {
    if (chartContainerRef.current) {
      ...
      if (chartType === "candles") {
        const themeConfig = themesData[currentTheme];
        const candlestickSeries = chartInstance.addCandlestickSeries({
          upColor: themeConfig.series.topColor,
          downColor: themeConfig.series.bottomColor,
          borderVisible: false,
          wickUpColor: themeConfig.series.topColor,
          wickDownColor: themeConfig.series.bottomColor,
        });
        const data = [
        ...
        const themeConfig = themesData[currentTheme];
        const areaSeries = chartInstance.addLineSeries({
          color: themeConfig.series.topColor,
        });
