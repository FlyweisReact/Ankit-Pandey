...
const Dashboard = () => {
  ...
  const [gridContDimensions, setGridContDimensions] = useState({
    width: 0,
    height: 0,
  });
  ...
  useEffect(() => {
    const gridCont = document.querySelector(".homeS");
    if (gridCont) {
      const { width, height } = gridCont.getBoundingClientRect();
      setGridContDimensions({ width, height });
    }
  }, []);
      ...
      <div className="homeS">
        ...
        <div className="gridCont">
          ...
          <Draggable
            ...
            left: 0,
            top: 0,
            right: gridContDimensions.width,
            bottom: gridContDimensions.height,
          }}
