...
chartInstance.subscribeCrosshairMove((param) => {
  if (
    ...
    const data = param.seriesPrices && param.seriesPrices.get(lineSeries); // Use lineSeries instead of areaSeries
    const price = data?.price; // Use 'price' instead of 'value'
    tooltipRef.current.innerHTML = `
      <div style="color: rgba(0, 150, 136, 1)">Apple Inc.</div>
    ...
    const coordinate = lineSeries.priceToCoordinate(price); // Use lineSeries for priceToCoordinate
    const shiftedCoordinate = param.point.x - tooltipRef.current.clientWidth / 2;
